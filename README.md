...
![](figs/ReCTR-blockdg.png)

**Dependencies to run the ReCTR**

The implementation of "ReCTR" is based on Python 3.8.8 and [PyTorch](https://pytorch.org/) 1.8.0. To install all required dependencies:
```
...
Please follow the instructions we have included below to get res101.mat and att_splits.mat files, and place them in ZSSC_ReCTR/data/xlsa17/data/{dataset}/... 
...
Then, place **res101.mat** and **att_splits.mat** files into ZSSC_ReCTR/data/xlsa17/data/{dataset}/...

Example for the UCM dataset: 
```
          ZSSC_ReCTR/data/xlsa17/data/UCM/res101.mat    
          ZSSC_ReCTR/data/xlsa17/data/UCM/att_splits.mat
```
...
Run the given commands to train the "ReCTR" from scratch:

```
$ python train_ReCTR_ucm.py   # UCM
$ python train_ReCTR_aid.py   # AID
$ python train_ReCTR_nwpu.py  # NWPU
```
